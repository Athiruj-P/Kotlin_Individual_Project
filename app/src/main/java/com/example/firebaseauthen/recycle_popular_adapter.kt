...
class recycle_popular_adapter(context: Context, val dataSource: JSONArray) : RecyclerView.Adapter<recycle_popular_adapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent : ViewGroup, viewType: Int): Holder {
        return Holder(LayoutInflater.from(parent.context).inflate(R.layout.recycle_popular, parent, false))
    }
